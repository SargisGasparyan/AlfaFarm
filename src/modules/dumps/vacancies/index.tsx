...
import * as animationData from 'assets/animations/EmptyCareer.json';
...
class Vacancies extends HelperPureComponent<{}, IState> {
    ...
    public state: IState = {data: [], isLoading: true};
    ...
    public render() {
        ...
        return (
            <section className="G-page P-vacancies-page">
                ...
                {data.length ? data.map(item => <ListItem key={item.id} data={item}/>) :
