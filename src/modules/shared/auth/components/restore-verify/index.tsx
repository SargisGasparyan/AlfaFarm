...
class RestoreVerfiy extends HelperComponent<IProps, IState> {
  ...
  public componentDidMount() {
    ...
    this.safeSetState({ loading: true }, async () => {
      const result = await AuthController.ForgotVerify({ email: data.email, code: data.code });
