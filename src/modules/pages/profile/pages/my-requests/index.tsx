...
import { requestStatusClass } from 'modules/shared/request/services/helper';
...
class MyRequests extends HelperPureComponent<{}, IState> {
  ...
  public render() {
    ...
    return (
      <section className="G-page P-my-requests-page">
        <h1 className="G-page-title">{Settings.translations.my_requests}</h1>
