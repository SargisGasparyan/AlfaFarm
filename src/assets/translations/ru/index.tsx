...
export default {
  ...
  special_product_confirm: 'Вы уверены что хотите обновить особый товар?',
  ...
  about_delivery_text: "Доставка онлайн аптеки Альфа-Фарм доступна в городе Ереван и Гюмри обычно в течение 2 часов после регистрации заказа.",
  about_delivery_text_2: "В регионах доставка осуществляется либо посредством почтовой компании «Айпост» обычно в течение 3-х дней доставляя товары в соответствующее отделение «Айпост», откуда покупатель заберет товары, либо при желании покупателя обычно в течение 3-х дней товары доставляются в ближайщую аптеку Альфа-Фарм, откуда покупатель заберет свои товары. Более подробно можно ознакомиться в разделе «Условия доставки».",
  about_bonus_card_text: "Бонусная карта Альфа-Фарм дает покупателям возможность аккумулировать бонусные баллы от покупок в аптеках Альфа-Фарм, положить предоплату на свой счет и использовать при покупках в аптеках Альфа-Фарм.",
  about_bonus_card_text_2: "Более подробно можно ознакомиться в разделе «Условия Альфа карты».",
