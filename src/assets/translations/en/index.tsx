...
export default {
  ...
  next: "Next",
  next_step: "Next",
  accumulative_bonus: "Accumulative bonus",
  order: "Order",
  ...
  today: "Today",
  appointments_cancel: "Cancel Appointement",
  appointments_cancel_text: "Are yo sure you want to cancel your appointement?",
  prescription_delete: "Remove prescription",
  prescription_delete_text: "Are yo sure you want to remove prescription?",
  ...
  bonus_card_empty: "You haven't had a Bonus history",
  ...
  wholesale_sale_online_sale: "Online sale",
