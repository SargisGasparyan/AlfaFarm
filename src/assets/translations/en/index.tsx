...
export default {
  ...
  about_delivery_text: "Delivery of the products purchased form the online drugstore of Alfa Pharm is available in Yerevan and Gyumri and generally takes up to 2 hours since the registration of the order.",
  about_delivery_text_2: "In regions the delivery is organized either thorugh mailing company “Haypost” generally in up to 3 days by delivering the products to the respective Haypost branch, where the customer can take his/her order, or through Alfa-Pharm generally in up to 3 days by delivering the products to the nearest Alfa-Pharm branch, where the customer can take his/her order. More details are available in the “Delivery conditions” section.",
  about_bonus_card_text: "Alfa Pharm bonus card lets customers accumulate bonus points from the purchases in Alfa Pharm drugstores, add prepaid amount to their account and then spend them when pruchasing from Alfa Pharm.",
  about_bonus_card_text_2: "More details are available in “Alfa card conditions” section.",
